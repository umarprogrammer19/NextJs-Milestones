...
const GetStarted = () => {
  return (
    <a
      href="#features"
      className="hover:shadow-md transition-all hover:shadow-secondary md:w-[140px] md:h-[140px] sm:w-[180px] sm:h-[180px] w-[90px] h-[90px] bg-blue-gradient cursor-pointer select-none capitalize font-poppins flex items-center justify-center rounded-full hover:scale-110"
    >
